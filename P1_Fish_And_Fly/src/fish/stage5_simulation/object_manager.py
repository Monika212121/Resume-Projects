...
from src.fish.stage5_simulation.clamper import clamp_garbage_position
...
class ObjectManager():
    def __init__(self):
        self.object_bodyID: Dict[int, int] = {}                                                             # Dict{object_id, pybullet_body_id}
        self.objects_spawned: Dict[int, WorldObject] = {}                                                   # Dict{object_id, world_object}
    ...
    def create_sim_world_object_from_fish_frame(self, fish_frame_obj: FishFrameObject, fish_pos: Waypoint, fish_direction: int) -> WorldObject:
        ...
        safe_garbage_position = clamp_garbage_position(position= garbage_world_position)
    ...
    def spawn_garbage(self, world_obj: WorldObject) -> None:
        try:
            ...
            garbage_body_id = create_garbage_body(position= spawn_pos, radius= world_obj.radius)
